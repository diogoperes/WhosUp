...
public class PlacePicker extends Activity {
    ...
    public interface OnDetailFetched {
        void completed(PlaceDetail placeInfoDetail);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String query) {
                ...
                final String apiKey = getIntent().getStringExtra(PARAM_API_KEY);
    ...
    private void sendResult(PlaceDetail placeDetail) {
        ...
        resultIntent.putExtra(PARAM_LATITUDE, placeDetail.latitude.toString());
        resultIntent.putExtra(PARAM_LONGITUDE, placeDetail.longitude.toString());
    ...
    public static PlaceDetail fromIntent(Intent intent) {
        return intent.getExtras().getParcelable(PARAM_RESULT);
    }
